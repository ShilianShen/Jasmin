...
typedef union {struct {int i, j;} v; int arr[2];} Vec2i;
...
Vec3f BASIC_GetMinus(Vec3f A, Vec3f B);
Vec3f BASIC_GetWeightedAdd(float wa, float wb, Vec3f A, Vec3f B);
Vec3f BASIC_GetScaledVec(float scale, Vec3f vec);
